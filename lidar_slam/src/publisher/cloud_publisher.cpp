...
namespace lidar_slam {
    ...
    void CloudPublisher::Publish(const CloudData::CLOUD_PTR& cloud_ptr_input, double time) {
    ...
    void CloudPublisher::PublishData(const CloudData::CLOUD_PTR& cloud_ptr_input, ros::Time time) {
