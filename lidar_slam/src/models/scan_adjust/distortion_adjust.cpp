//
// Created by xcmworkharder on 2020-08-18 上午7:19.
//
#include "lidar_slam/models/scan_adjust/distortion_adjust.h"
#include "glog/logging.h"

namespace lidar_slam {
    void DistortionAdjust::SetMotionInfo(float scan_period, const VelocityData& velocity_data) {
        scan_period_ = scan_period;
        velocity_ << velocity_data.linear_velocity.x,
                velocity_data.linear_velocity.y,
                velocity_data.linear_velocity.z;
        angular_rate_ << velocity_data.angular_velocity.x,
                velocity_data.angular_velocity.y,
    ...
    bool DistortionAdjust::AdjustCloud(CloudData::CLOUD_PTR& input_cloud_ptr,
        ...
        //output_cloud_ptr->points.clear(); // 这里在rviz启动会在data_preprocess处process has died错误
